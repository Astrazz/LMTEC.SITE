   ...
   <tbody>
       <tr>
           <td class='header-row-td' width='378' style='font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;' valign='top' align='center'>
            <img src='https://expansom.com/site/images/logo.png' width='200' />
           </td>
       </tr>
   </tbody>
</table>
<h1 style='font-family: Arial, sans-serif; font-weight: normal; line-height: 19px; color: #999; margin: 0px; font-size: 15px; padding-bottom: 10px; padding-top: 15px;'>
    Olá {{$nome}}, sua solicitação de agendamento foi recebida com sucesso. Estaremos entrando em contato o mais breve possível.<br>
    Esta é uma mensagem automática de nosso site você não precisa responder.<br>
   Esta mensagem foi enviada através do aplicativo em {{date('d/m/Y')}}.
</h1>
</td>
</tr>
</tbody>
...
<table width='100%' cellspacing='0' cellpadding='0' border='0' style='table-layout: fixed;'><tbody><tr><td width='100%' align='center' bgcolor='#f5f5f5' style='font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center; padding: 9px; border-width: 1px 0px 0px; border-style: solid; border-color: #e3e3e3; background-color: #f5f5f5;' valign='top'>
 <a href='#' style='color: #428bca; text-decoration: none; background-color: transparent;'>EXPANSOM &copy; {{date('Y')}}</a>
</td></tr></tbody></table>
</td></tr></tbody></table>
</td></tr></tbody></table>
