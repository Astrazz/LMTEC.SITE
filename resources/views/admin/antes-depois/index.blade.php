        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Antes e Depois Cadastrados</h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('andes.depois.create') }}" class="btn btn-primary btn-sm">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                    ...
                                    <thead>
                                        ...
                                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                            <th class="min-w-125px sorting"> Serviço</th>
                                            <th class="min-w-125px sorting"> Antes</th>
                                            <th class="min-w-125px sorting"> Depois</th>
                                    ...
                                    <tbody class="text-gray-600 fw-bold">
                                        @foreach ($dds as $servico)
                                            <tr class="odd">
                                                <td><img src="{{ url("storage/{$servico->antes}") }}" alt="{{ $servico->titulo }}" class="w-100"></td>
                                                <td><img src="{{ url("storage/{$servico->depois}") }}" alt="{{ $servico->titulo }}" class="w-100"></td>
                                                <td class="text-end">
                                                    <a href="{{route('andes.depois.show', $servico->id)}}" class="btn btn-light btn-active-light-primary btn-sm">
                                                        Gerenciar
                                                    </a>
                                                </td>
                                            </tr>
