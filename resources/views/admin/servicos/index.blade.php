        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Serviços Cadastrados</h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('servico.create') }}" class="btn btn-primary">
                                                    ...
                                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                        <a href="">
                                                            <div class="symbol-label">
                                                                <img src="{{ url("storage/{$servico->image}") }}"
                                                                    alt="{{ $servico->name }}" class="w-100">
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <div class="d-flex flex-column">
                                                        <a href=""
                                                            class="text-gray-800 text-hover-primary mb-1">{{ $servico->titulo }}</a>
                                                    </div>
                                                </td>
                                                <td class="text-end">
                                                    <a href="{{route('servico.show', $servico->id)}}" class="btn btn-light btn-active-light-primary btn-sm">
                                                        Gerenciar
                                                    </a>
                                                </td>
                                            </tr>
