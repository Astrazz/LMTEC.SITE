...
@section('titulo', 'Cadastro de Páginas')
@section('content')
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Cadastro de Páginas</h1>
                </div>
                <div class="d-flex align-items-center py-1">
                    <a href="{{ route('paginas.index') }}" class="btn btn-sm btn-primary">Páginas</a>
                </div>
            </div>
        </div>
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <form method="POST" action="{{ route('pagina.store') }}" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body border-top p-9">
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Imagem</label>
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="file" name="image" id="image" class="form-control form-control-lg form-control-solid" placeholder="Imagem">
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                </div>
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Titulo</label>
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Menu</label>
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select name="menu" id="menu" class="form-control form-control-lg form-control-solid">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <textarea name="descricao" id="kt_docs_ckeditor_classic"></textarea>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <button type="submit" name="executar" class="btn btn-primary"
