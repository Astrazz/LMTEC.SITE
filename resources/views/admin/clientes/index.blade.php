        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Clientes Cadastrados
                        ({{ count($clientes) }})</h1>
                </div>
            </div>
        </div>
                                                    ...
                                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                        <a href="">
                                                            <div class="symbol-label">
                                                                <img src="{{ !empty($cliente->image) ? 'storage/'.$cliente->image : 'admin/assets/media/user.png' }}"
                                                                    alt="{{ $cliente->nome }}" class="w-100">
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <div class="d-flex flex-column">
                                                        <a href=""
                                                            class="text-gray-800 text-hover-primary mb-1">{{ $cliente->nome }}</a>
                                                    </div>
                                                </td>
                                                <td class="text-end">
