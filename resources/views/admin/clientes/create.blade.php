        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Cadastro de Clientes</h1>
                </div>
                <div class="d-flex align-items-center py-1">
                    <a href="{{ route('clientes.index') }}" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                        data-bs-target="#kt_modal_create_app" id="kt_toolbar_primary_button">Clientes</a>
                </div>
            </div>
        </div>
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show">
                        <form enctype="multipart/form-data" name="personForm" id="personForm" method="POST" action="{{ route('clientes.store') }}"
...
@section('js')
    ...
    <script src="{{url('admin')}}/assets/js/custom/account/settings/deactivate-account.js"></script>
    <script src="{{url('admin')}}/assets/js/custom/modals/two-factor-authentication.js"></script>
