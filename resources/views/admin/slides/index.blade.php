        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Slides Cadastrados</h1>
                </div>
            </div>
        </div>
                                                        ...
                                                        <a href="">
                                                            <div class="symbol-label">
                                                                <img src="{{ url("storage/{$slide->image}") }}"
                                                                    alt="{{ $slide->titulo }}" class="w-100">
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <div class="d-flex flex-column">
                                                        <a href=""
                                                            class="text-gray-800 text-hover-primary mb-1">{{ $slide->titulo }}</a>
                                                    </div>
                                                </td>
                                                <td class="text-end">
                                                    <a href="{{route('slide.show', $slide->id)}}" class="btn btn-light btn-active-light-primary btn-sm">
                                                        Gerenciar
                                                    </a>
                                                </td>
                                            </tr>
