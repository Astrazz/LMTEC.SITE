...
<head>
    ...
    <meta property="og:title" content="@yield('titulo') - Vet Care Bahia" />
    <meta property="og:url" content="https://lopakdesigner.com" />
    <meta property="og:site_name" content="{{ env('COPYRIGHT') }}" />
    <link rel="canonical" href="https://lopakdesigner.com" />
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <a href="{{route('painel.home')}}">
                        <img alt="Logo" src="{{url('admin')}}/assets/media/logos/login-branca.png" class="h-25px logo" />
                    </a>
                ...
                <div id="kt_header" style="" class="header align-items-stretch">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="{{route('painel.home')}}" class="d-lg-none">
                                <img alt="Logo" src="{{url('admin')}}/assets/media/logos/login-branca.png" class="h-30px" />
                            </a>
                        </div>
                        <!--end::Mobile logo-->
                        <!--begin::Wrapper-->
                                ...
                                <div class="d-flex align-items-stretch flex-shrink-0">
                                                        ...
                                                        <div class="scroll-y mh-200px mh-lg-350px">
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                <div class="symbol symbol-40px me-4">
                                                                    <img src="{{url('admin')}}/assets/media/avatars/150-1.jpg" alt="" />
                                                                </div>
                                                                <!--end::Symbol-->
                                                                <!--begin::Title-->
                                                                <div
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                <!--begin::Symbol-->
                                                                <div class="symbol symbol-40px me-4">
                                                                    <img src="{{url('admin')}}/assets/media/avatars/150-3.jpg" alt="" />
                                                                </div>
                                                                <!--end::Symbol-->
                                                                <!--begin::Title-->
                                                                <div
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                <!--begin::Symbol-->
                                                                <div class="symbol symbol-40px me-4">
                                                                    <img src="{{url('admin')}}/assets/media/avatars/150-8.jpg" alt="" />
                                                                </div>
                                                                <!--end::Symbol-->
                                                                <!--begin::Title-->
                                                                <div
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                <!--begin::Symbol-->
                                                                <div class="symbol symbol-40px me-4">
                                                                    <img src="{{url('admin')}}/assets/media/avatars/150-11.jpg" alt="" />
                                                                </div>
                                                                <!--end::Symbol-->
                                                                <!--begin::Title-->
                                                                <div
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                <!--begin::Symbol-->
                                                                <div class="symbol symbol-40px me-4">
                                                                    <img src="{{url('admin')}}/assets/media/avatars/150-12.jpg" alt="" />
                                                                </div>
                                                                <!--end::Symbol-->
                                                                <!--begin::Title-->
                                                                <div
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3"
                                        ...
                                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px"
                                            data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                                            data-kt-menu-placement="bottom-end">
                                            <img src="{{url('admin')}}/assets/media/avatars/150-26.jpg" alt="user" />
                                        </div>
                                        <!--begin::Menu-->
                                            ...
                                            <div class="menu-item px-3">
                                                <div class="menu-content d-flex align-items-center px-3">
                                                    ...
                                                    <div class="symbol symbol-50px me-5">
                                                        <img alt="Logo" src="{{url('admin')}}/assets/media/avatars/150-26.jpg" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Username-->
                                                    <div class="d-flex flex-column">
                                                ...
                                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="account/settings.html"
                                                            ...
                                                            <span class="symbol symbol-20px me-4">
                                                                <img class="rounded-1"
                                                                    src="{{url('admin')}}/assets/media/flags/united-states.svg" alt="" />
                                                            </span>English</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="account/settings.html" class="menu-link d-flex px-5">
                                                            <span class="symbol symbol-20px me-4">
                                                                <img class="rounded-1"
                                                                    src="{{url('admin')}}/assets/media/flags/spain.svg" alt="" />
                                                            </span>Spanish</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="account/settings.html" class="menu-link d-flex px-5">
                                                            <span class="symbol symbol-20px me-4">
                                                                <img class="rounded-1"
                                                                    src="{{url('admin')}}/assets/media/flags/germany.svg" alt="" />
                                                            </span>German</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="account/settings.html" class="menu-link d-flex px-5">
                                                            <span class="symbol symbol-20px me-4">
                                                                <img class="rounded-1"
                                                                    src="{{url('admin')}}/assets/media/flags/japan.svg" alt="" />
                                                            </span>Japanese</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="account/settings.html" class="menu-link d-flex px-5">
                                                            <span class="symbol symbol-20px me-4">
                                                                <img class="rounded-1"
                                                                    src="{{url('admin')}}/assets/media/flags/france.svg" alt="" />
                                                            </span>French</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                </div>
                                                ...
                                                <div class="menu-content px-5">
                                                    <label
                                                        ...
                                                        <input class="form-check-input w-30px h-20px" type="checkbox"
                                                            ...
                                                            data-kt-url="dark/{{route('painel.home')}}" />
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    <div
                        ...
                        <ul class="menu menu-gray-600 menu-hover-primary fw-bold order-1">
                            <li class="menu-item">
                                <a href="https://lopakdesigner.com/quem-somos/" target="_blank" class="menu-link px-2">Quem Somos</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://central.sitesemsalvador.com.br/clientarea.php" target="_blank"
                                    class="menu-link px-2">Suporte</a>
                            </li>
                            <li class="menu-item">
                                <a href="https://lopakdesigner.com" target="_blank"
                                    class="menu-link px-2">Lopak Tecnologia</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{url('admin')}}/assets/media/avatars/150-11.jpg" alt="img" />
                                        </div>
                                    </div>
                                </div>
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="{{url('admin')}}/assets/media/avatars/150-3.jpg" alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="{{url('admin')}}/assets/media/avatars/150-5.jpg" alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{url('admin')}}/assets/media/avatars/150-2.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{url('admin')}}/assets/media/avatars/150-6.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img alt="" class="w-30px me-3" src="{{url('admin')}}/assets/media/svg/files/doc.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="" class="w-30px me-3" src="{{url('admin')}}/assets/media/svg/files/css.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{url('admin')}}/assets/media/stock/300x270/9.jpg" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{url('admin')}}/assets/media/stock/300x270/11.jpg" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{url('admin')}}/assets/media/stock/300x270/6.jpg" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{url('admin')}}/assets/media/avatars/150-14.jpg" alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{url('admin')}}/assets/media/avatars/150-15.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{url('admin')}}/assets/media/avatars/150-26.jpg" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::User-->
